        ...
        foreach($notifications as $notification){
            ...
            try{
                if($job){
				    ...
				    Notification::insert(['notification_type'=>'new_proposal', 'to_user_id'=>$proposal->user_id, 'notification_title'=>"Your proposal for job {$job->job_title} accepted", 'notification_link' => route('web.partner.ongoing.jobs.detail',$job->id .'-'. $notification->proposal_id ) ]);
				    ...
				    Notification::insert(['notification_type'=>'new_proposal', 'to_user_id'=>$proposal->user_id, 'notification_title'=>"Your proposal for job {$job->job_title} declined", 'notification_link' => route('web.partner.job.detail',$job->id ) ]);
				    ...
				    Notification::insert(['notification_type'=>'new_proposal', 'to_user_id'=>$proposal->user_id, 'notification_title'=>"Your work for job {$job->job_title} submission request is accepted.", 'notification_link' => route('web.partner.ongoing.jobs.detail',$job->id .'-'. $notification->proposal_id ) ]);
                    ...
                    Notification::insert(['notification_type'=>'new_proposal', 'to_user_id'=>$proposal->user_id, 'notification_title'=>"Your work for job {$job->job_title} submission request is rejected.", 'notification_link' => route('web.partner.ongoing.jobs.detail',$job->id .'-'. $notification->proposal_id ) ]);
                            break;
