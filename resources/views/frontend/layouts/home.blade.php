...
<head>
		...
		@if( isset($cms_content_values) )
			@foreach ($cms_content_values as $key => $meta_key_values)
				<title>{{ $meta_key_values->title }}</title>
				<meta name="description" content="{{ $meta_key_values->metadescrption }}">
				<meta name="keywords" content="{{ $meta_key_values->keyword }}">
			@endforeach
		@else    		
				<title>Find &Hire Freelancers in India| Freelancing Platform | Frobity</title>
				<meta name="description" content="Hire the best freelancers for your work in India.A concrete framework for high paying jobs and individual skills enhancements. Get online projects & earn money.">
				<meta name="keywords" content="hire freelancers india">
	    ...
	    <link rel="canonical" href="{{'https://www.frobity.com/' . request()->path()}}" >
		<!-- ==============================================
		CSS
		=============================================== -->
        <!-- Style-->
		...
		<!-- Global site tag (gtag.js) - Google Analytics -->
				<script async src="https://www.googletagmanager.com/gtag/js?id=G-6CBQ083Q50"></script>
				<script>
				window.dataLayer = window.dataLayer || [];
				function gtag(){dataLayer.push(arguments);}
				gtag('js', new Date());
				gtag('config', 'G-6CBQ083Q50');
				</script>
		<meta name="google-site-verification" content="uiKoMQJMVqG_SV08Wp09LPuCtSy9JNQMPt35a-Zi_C8" />
	 ...
	 <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
       <!-- Brand and toggle get grouped for better mobile display -->
	     <a class="navbar-brand" href="{{ route('web.home')}}"><img src="{{ asset('assets/img/logo.png') }}" style="height: 36px; float: left;   margin-right: 10px;" alt="Frobity">FROBITY</a>	
         ...
         <div class="container">
          <div class="row">
           ...
           <div class="col-md-4 col-sm-6 text-left">
            ...
            <hr class="mint">
            <p>Frobity is an Indian freelancer-specific market website, centred around creating a platform where freelancers can offer their services to potential employers.</p>
			<br>
			<p>Frobity strives to create connections between potential employers and employees by allowing employers to post jobs for freelancers to bid on in a competitive bidding process.
			</p>
           </div><!-- /.col-md-4 -->
           ...
           <div class="col-md-2 col-sm-6 text-left">
            ...
            <div class ="no-padding">
             ...
             <a href="<?php echo url("/") ?>/freelancers">Freelancers</a>
             <a href="<?php echo url("/") ?>/how-it-works">How it works</a>
           ...
           <hr class="mint">
            <div class="no-padding">
              <!--<a href="#">Top Freelancers this Month of June</a>-->
              <a href="#">Top Freelancers by Skill</a>
              <a href="<?php echo url("/") ?>/top-freelancer-by-city/Delhi">Top Freelancers in Delhi</a>
              <a href="<?php echo url("/") ?>/top-freelancer-by-city/Mumbai">Top Freelancers in Mumbai</a>
              <a href="<?php echo url("/") ?>/top-freelancer-by-city/Chennai">Top Freelancers in Chennai</a>
              <a href="<?php echo url("/") ?>/top-freelancer-by-city/Kolkata">Top Freelancers in Kolkata</a>		  
             </div>
            </div><!-- /.col-md-3 -->
