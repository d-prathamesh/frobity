...
<html lang="en">
  <head>
        ...
        <title>Hire Bunny | Freelacing plateform</title>
      ...
      <nav class="navbar navbar-default navbar-fixed-top">
       <div class="container">
	    <div class="navbar-header">
		 ...
		 <a class="navbar-brand" href="{{ route('web.partner.dashboard') }}"><img src="{{ asset('assets/img/logo.png') }}" style="height: 18px; float: left;   margin-right: 10px;"/>Hire Bunny</a>
		</div><!-- /.navbar-header -->
