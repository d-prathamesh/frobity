...
<ul class="work" style="padding:10px 0px;">
        ...
        <div class="col-lg-12">
          <div class="icon">
           <p class="tr-title"><i class="fa fa-list" aria-hidden="true"></i>On-Going Jobs</p>
          </div> 
        </div> 
   
    @forelse($ongoingJobs as $lead)
    <?php 
    $newlist = [];
      ...
      <div class="row bottom-sec">
       <div class="col-lg-12">
        ...
        <div class="col-lg-12">
         ...
         <h5><a href="{{ route('web.partner.ongoing.jobs.detail',['leadProId'=>$lead['id'].'-'.$lead['active_contract']['id']]) }}">  {{$lead['job_title']}} </a> 
