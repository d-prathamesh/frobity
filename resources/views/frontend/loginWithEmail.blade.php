      ...
      <div class="row">
       ...
       <main class="main main-signup col-lg-12">
        <div class="col-lg-6 col-lg-offset-3 text-center">
         <div class="form-sign">
          <form id="otp-form" action="{{ route('web.postLoginWithEmail',['type'=>$type])}}" method="post">
                {{ csrf_field() }}
           <div class="form-head">
                <div class="row">
           ...
           <div class="form-body">
            ...
            <div class="form-row">
             <div class="form-controls">
              <input name="email" placeholder="email@domain.com" class="field @if($errors->has('email')) has-error @endif" type="email">
             </div><!-- /.form-controls -->
            
            </div><!-- /.form-row -->
            <div class="form-row">
             <div class="form-controls">
              <input name="password" placeholder="******" class="field @if($errors->has('email')) has-error @endif" type="password">
             </div><!-- /.form-controls -->
           ...
           <div class="form-foot">
            ...
            <div class="mt-2">
                <a  class="more-link" href="{{ route('web.otp',['type'=>$type])}}">Login With Mobile</a>
