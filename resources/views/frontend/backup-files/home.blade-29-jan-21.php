...
<!-- ==============================================
	...
	=============================================== -->
	 ...
	 <div class="container text-center">
		...
		<div class="col-lg-3 col-md-3 col-sm-6 hover">
...
$(document).ready(function () {
    $('.hover').first().addClass('active');
    $('.info').first().show().animate({width: '25%'});
    $('.hover').click(function () {
        $(this).addClass("active").siblings('.hover').removeClass('active');
        $(this).next().show().animate({width: '25%'}).siblings('.info').animate({width: 0}, function () {
            $(this).hide();
        });
});
});
