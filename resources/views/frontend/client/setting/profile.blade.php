...
<ul class="work" style="padding:10px 0px;">
        ...
        <li class="job-box" style="">	
                        <div  class="col-md-3 text-center profile-image-border">
                                        <img src="{{ session('client')['image'] }}" onError="this.onerror=null;this.src='/assets/img/default-user.svg';" class="img-resonsive" width="150px" height="150px" alt="...">
                        <form id="submission-form" method="post" action="{{route('web.client.setting.save-profile-picture')}}" enctype="multipart/form-data">
        ...
        @endif 
                        ...
                        <br/>
                <form method="post" action="{{ route('web.client.setting.save-profile') }}">
				...
				<input type="text"  class="form-control" placeholder="Email" value="{{ $profile['email'] }}" disabled />
						...
						<div class="form-group">
							<input type="text"  class="form-control" placeholder="Your Mobile" value="{{ $profile['mobile'] }}" disabled />
						</div>
				<div class="form-group">
