          ...
          <div class="card-box-profile">
            ...
            <div class="media-body">
                                    ...
                                    <li>
                                        ...
                                        <div class="clearfix"></div>
											...
											<?php 
											  ...
											  // echo "<pre>";
											  // print_r(end($new_file_id));	
											  // echo "</pre>";
											   ?>
                                            <p><a href="{{url('/attachments/'. end($new_file_id))}}" class="card-link" target="_blank"  download><i class="fa fa-files-o"></i>  {{$attachments['file_name']}}</a></p>
                                            @endforeach
                                    </li>
                                    @endforeach
                                </ul>
                ...
                @if($lead['status'] == 'InReview')
                    <p> You can send message and take follow up.</p>
                @endif
