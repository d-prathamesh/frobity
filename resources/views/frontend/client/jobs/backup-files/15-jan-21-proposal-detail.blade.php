         ...
         <div class="col-lg-12 col-md-12 col-sm-6 col-xs-12">
          ...
          <div class="col-lg-12 top-sec">
           ...
           <div >
            ...
            <button onclick="declineJob()" type="button" class="kafe-btn kafe-btn-mint-small">
							Decline
						</button>
...
function declineJob(){
	 ...
	 $.ajax({
		 'method':'post',
		 'url':'{{route('web.client.posted.jobs.decline',['id'=>$proposal['job']['id'],'proposalId'=>$proposal['id']])}}',
